...
### Role
Analisa os dados fictícios e produz o diagnóstico sintético.
...
2. Executar só a responsabilidade única desta persona (Analisa os dados fictícios e produz o diagnóstico sintético).
