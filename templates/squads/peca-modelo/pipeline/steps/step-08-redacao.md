...
outputFile: squads/peca-modelo/output/peca-modelo-minuta.md
---
...
3. Gravar no artefato declarado. Em re-execução por on_reject, aplicar só os fixes; em modo ajustes (aprovação com ajustes), aplicar só os ajustes de forma, sem tocar em citação.

## Output Format

Grava em `squads/peca-modelo/output/peca-modelo-minuta.md`. O artefato é Markdown, com o cabeçalho de primeiro nível nomeando o que o step produz. Um exemplo completo está na seção seguinte.
