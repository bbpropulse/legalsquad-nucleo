 ...
 */
import { ehCasaLegalSquad } from './fs-utils.js';
export { ehCasaLegalSquad };
...
export function formatarBriefing(agregado, { hoje = hojeNoForo(), chefe = CHEFE_PADRAO } = {}) {
  ...
  if (stale) {
    ...
    const dica = agregado.varredura?.configurada === false
      ? ' Para eu varrer o DJEN sozinho todo dia, me diga o número da OAB e a UF do escritório: eu guardo e passo a monitorar.'
      : '';
