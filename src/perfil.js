...
//
// O motor tem os botões há tempo (`citation_verifiers`, `meta_verifiers`, teto
// de ciclos de revisão, gate de sobrevivência ao resumo, red-team), mas cada
...
// verificação de citações: o mínimo é 1 verificador, sempre.
//
