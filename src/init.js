...
export function ligarBibliotecaDaMaquina(targetDir, { deposito: depositoExplicito = null } = {}) {
  ...
  if (estado.novo || Object.keys(estado.packs).length === 0) {
    ...
    console.log(`  ℹ️  biblioteca da máquina ainda vazia (${deposito}): rode \`npx legalsquad acervo sync\` uma vez nesta máquina; skills e jurisprudência entram neste projeto e em todos os seguintes`);
    return null;
  }
